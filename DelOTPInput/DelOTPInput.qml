...
Item {
    ...
    property color colorItemText: enabled ? "#000" : Qt.rgba(0,0,0,0.45)
    property color colorItemBorder: enabled ? Qt.rgba(0,0,0,0.25) : "transparent"
    property color colorItemBorderActive: enabled ? "#1677ff" : "transparent"
    property color colorItemBg: enabled ? "#fff" : Qt.rgba(0,0,0,0.1)
