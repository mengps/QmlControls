...
Item {
        ...
        colorBg: {
            if (enabled) {
                if (checked)
                    ...
                    return down ? Qt.rgba(0,0,0,0.15) : hovered ? Qt.rgba(0,0,0,0.06) : "#fff";
            } else {
                return checked ? Qt.rgba(0,0,0,0.2) : "transparent";
            }
        }
        colorBorder: checked ? "#1677ff" : "transparent"
        onClicked: {
    ...
    component ActionButton: Item {
        ...
        DelIconButton {
            ...
            effectEnabled: false
            colorBorder: "transparent"
            colorBg: enabled ? (down ? Qt.rgba(0,0,0,0.15) :
                                       hovered ? Qt.rgba(0,0,0,0.06) : "transparent") : "transparent"
