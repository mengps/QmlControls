...
DelRectangle {
    ...
    property color colorGridLine: Qt.rgba(0,0,0,0.04)

    property bool columnHeaderVisible: true
    property font columnHeaderTitleFont
    property color colorColumnHeaderTitle: "#000"
    property color colorColumnHeaderBg: Qt.rgba(0,0,0,0.06)

    property bool rowHeaderVisible: true
    property font rowHeaderTitleFont
    property color colorRowHeaderTitle: "#000"
    property color colorRowHeaderBg: Qt.rgba(0,0,0,0.06)

    property color colorResizeBlockBg: Qt.rgba(0,0,0,0.04)
    ...
    property Component columnHeaderSorterIconDelegate: Item {
        ...
        Column {
            ...
            DelIconText {
                ...
                colorIcon: sortMode === 'ascend' ? "#1677ff" : Qt.rgba(0,0,0,0.45)
            ...
            DelIconText {
                ...
                colorIcon: sortMode === 'descend' ? "#1677ff" : Qt.rgba(0,0,0,0.45)
    ...
    property Component columnHeaderFilterIconDelegate: Item {
        ...
        HoverIcon {
            ...
            colorIcon: hovered ? "#1677ff" : Qt.rgba(0,0,0,0.45)
            onClicked: {
                __filterPopup.open();
            }
        }
            ...
            delegate: Rectangle {
                ...
                color: {
                    if (__private.checkedKeysMap.has(key)) {
                        ...
                        return row == __cellView.currentHoverRow ? Qt.rgba(0,0,0,0.06) :
